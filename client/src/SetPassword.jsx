    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: "440px", textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "12px", color: "#A87C2A", margin: "0 0 24px", fontStyle: "italic", letterSpacing: "2px" }}>
          {status === "success" ? "Password Set" : "Set Your Password"}
        </p>
        ...
        <div style={{
          ...
          {status === "success" ? (
            <div style={{ textAlign: "center", padding: "16px 0" }}>
              ...
              <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "15px", color: "#666", margin: "0 0 28px" }}>You can now sign in to your account.</p>
              <button
            ...
            <>
              ...
              <div style={{ marginBottom: "24px", textAlign: "left" }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  />
                  <button onClick={() => setShowPassword(!showPassword)} style={{ position: "absolute", right: "4px", top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", padding: "4px" }}>
                    {showPassword ? (
